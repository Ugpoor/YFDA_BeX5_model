...
var __parent1=require('$model/UI2/system/templates/common/formView'); 
var __parent0=require('$model/UI2/system/templates/common/noTitleFormView'); 
var __result = __parent2._extend(__parent1)._extend(__parent0).extend({
	...
	this.__id='';
	this.__cid='cnENn6b';
	this._flag_='68636f8378e580628e800d395a1bee46';
