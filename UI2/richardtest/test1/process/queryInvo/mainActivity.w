...
<div xmlns="http://www.w3.org/1999/xhtml" component="$UI/system/components/justep/window/window" xid="window" design="device:pc;">  
  <div component="$UI/system/components/justep/model/model" xid="model" style="height:auto;left:334px;top:318px;"> 
    <div component="$UI/system/components/justep/data/bizData" xid="mainData"
      directDelete="true" autoLoad="true" concept="RI_RY" columns=""
      onSaveCommit="saveCommit" limit="20">
      <reader action="/richardtest/test1/logic/action/queryRI_RYAction"/>  
      <writer action="/richardtest/test1/logic/action/saveRI_RYAction"/>  
      <creator action="/richardtest/test1/logic/action/createRI_RYAction"/>  
  ...
  <div xid="view"> 
    <div component="$UI/system/components/justep/toolBar/toolBar" class="x-toolbar x-toolbar-spliter form-inline"
      ...
      <div component="$UI/system/components/justep/smartFilter/smartFilter"
        xid="smartFilter1" filterData="mainData" filterCols="fMZ,fXB"
        class="pull-right"> 
    ...
    <div component="$UI/system/components/justep/grid/grid" xid="mainGrid"
      ...
      <columns xid="column"> 
        <column name="fMZ" editable="true"> 
          <editor> 
            <input component="$UI/system/components/justep/input/input" class="form-control"
              bind-ref="ref('fMZ')"/> 
          </editor> 
        </column>
        <column name="fXB" editable="true"> 
          <editor> 
            <input component="$UI/system/components/justep/input/input" class="form-control"
              bind-ref="ref('fXB')"/> 
          </editor> 
