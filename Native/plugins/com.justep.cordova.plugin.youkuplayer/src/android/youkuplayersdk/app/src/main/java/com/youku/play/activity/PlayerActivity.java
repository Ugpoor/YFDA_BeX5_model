package com.youku.play.activity;
...
public class PlayerActivity extends Activity {
	...
	// 清晰度相关按钮
	public static Button btn_standard, btn_hight, btn_super, btn_1080;
	...
	private void getIntentData(Intent intent) {
		...
		if (intent != null) {
			...
			if (isFromLocal) { // 播放本地视频
				...
				videoquality=intent.getIntExtra("videoquality",0);
			}
		}
...
//		btn_download.setOnClickListener(listener);
		...
		btn_hight.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View v) {
				change(VideoQuality.HIGHT);
			}
		...
		btn_1080.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View v) {
				change(VideoQuality.P1080);
			}
