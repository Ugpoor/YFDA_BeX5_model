...
- (void)getParam:(CDVInvokedUrlCommand *)command{
    if (![_appId isEqualToString:@""]) {
        NSDictionary *appIdDic = @{@"qq_app_id":_appId};
        CDVPluginResult *result = [CDVPluginResult resultWithStatus:CDVCommandStatus_OK messageAsDictionary:appIdDic];
...
- (void)handleSendResult:(QQApiSendResultCode)sendResult {
    switch (sendResult) {
        ...
        case EQQAPISENDFAILD: {
            CDVPluginResult *pluginResult = [CDVPluginResult resultWithStatus:CDVCommandStatus_ERROR messageAsString:@"SendResultFail"];
            [self.commandDelegate sendPluginResult:pluginResult callbackId:self.callback];
            break;
        }
