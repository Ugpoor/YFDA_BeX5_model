...
public class XWalkWebViewEngine implements CordovaWebViewEngine {
    ...
    public XWalkWebViewEngine(Context context, CordovaPreferences preferences) {
        ...
        Runnable completeCommand = new Runnable() {
            ...
            public void run() {
                ...
                initWebViewSettings();
                exposeJsInterface(webView, bridge,getCordovaWebView());
    ...
    private void initWebViewSettings() {
        ...
        //AppendUserAgent
        String appendUserAgent = preferences == null ? "" : preferences.getString("AppendUserAgent", "");
        if (!appendUserAgent.isEmpty()) {
            ...
            try{
                ...
                String userAgent = xWalkSettings.getUserAgentString();
                webView.setUserAgentString(userAgent + appendUserAgent);
            }catch (Exception e){
            }
        }
    ...
    private static void exposeJsInterface(XWalkView webView, CordovaBridge bridge,CordovaWebView cordovaWebView) {
        XWalkExposedJsApi exposedJsApi = new XWalkExposedJsApi(bridge);
        webView.addJavascriptInterface(exposedJsApi, "_cordovaNative");
        CordovaDetect cordovaDetect = new CordovaDetect(cordovaWebView);
        webView.addJavascriptInterface(cordovaDetect, "_cordovaDetect");
    }
