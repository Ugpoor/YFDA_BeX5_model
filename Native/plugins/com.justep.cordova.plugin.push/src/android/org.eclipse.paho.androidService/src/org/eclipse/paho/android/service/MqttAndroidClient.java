...
public class MqttAndroidClient extends BroadcastReceiver implements
	...
	private final class MyServiceConnection implements ServiceConnection {
		...
		public void onServiceConnected(ComponentName name, IBinder binder) {
			...
			Log.i(TAG, "MyServiceConnection on serviceConnected call doConnect");
			doConnect();
		}
	...
	public IMqttToken connect(MqttConnectOptions options, Object userContext,
		...
		if (mqttService == null) { // First time - must bind to the service
			Log.i(TAG, "First time - must bind to the service");
			...
			pool.execute(new Runnable() {
				...
				@Override
				public void run() {
					Log.i(TAG, "mqttService is exist call doConnect");
					doConnect();
	...
	private void doConnect() {
		...
		try {
			Log.i(TAG, "call mqttService connect");
