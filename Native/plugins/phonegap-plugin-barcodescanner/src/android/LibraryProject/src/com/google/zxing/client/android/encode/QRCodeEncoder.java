...
import com.FakeR;
import com.android.Contents;
import com.google.zxing.BarcodeFormat;
import com.google.zxing.EncodeHintType1;
...
final class QRCodeEncoder {
  ...
  private void encodeFromStreamExtra(Intent intent) throws WriterException {
    ...
    try {
      ...
      throw new WriterException(ioe.toString());
    }
  ...
  Bitmap encodeAsBitmap() throws WriterException {
    ...
    Map<EncodeHintType1,Object> hints = null;
    String encoding = guessAppropriateEncoding(contentsToEncode);
    if (encoding != null) {
      hints = new EnumMap<EncodeHintType1,Object>(EncodeHintType1.class);
      hints.put(EncodeHintType1.CHARACTER_SET, encoding);
    }
    MultiFormatWriter writer = new MultiFormatWriter();
    BitMatrix result;
    try {
      result = writer.encode(contentsToEncode, format, dimension, dimension, (Hashtable) hints);
    } catch (IllegalArgumentException iae) {
      // Unsupported format
      return null;
    }
