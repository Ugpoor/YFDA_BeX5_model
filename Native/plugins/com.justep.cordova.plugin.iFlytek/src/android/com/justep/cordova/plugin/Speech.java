...
public class Speech extends CordovaPlugin implements RecognizerListener, SynthesizerListener, ContactListener, LexiconListener {
    ...
    private static  String SPEECH_APP_ID ;
    ...
    protected void pluginInitialize() {
        ...
        this.SPEECH_APP_ID = webView.getPreferences().getString( "appid", "");
    }
    ...
    public void onEvent(int eventType, int arg1, int arg2, Bundle msg) {
        Log.d(LOGTAG, "onEvent " + eventType + " " + arg1 + " " + arg2 + " " + msg);
    ...
    public void onVolumeChanged(int volume, byte[] data) {
    	Log.d(LOGTAG, "返回音频数据："+data.length);
    }
